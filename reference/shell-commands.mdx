---
title: "CrisOS v2 Shell Command Reference"
...
The CrisOS v2 shell (`shell_run()`) provides approximately 25 built-in commands. All commands are typed at the `> ` prompt. Type `help` to see the full command list inline. This page documents every command with its syntax, arguments, and behavior, grouped by category.
