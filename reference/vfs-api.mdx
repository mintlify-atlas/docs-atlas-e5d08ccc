---
title: "VFS and FS API Reference for CrisOS v2"
sidebarTitle: "VFS API"
description: "C function reference for the CrisOS v2 virtual file system (vfs.h) and raw CRFS filesystem layer (fs.h), including signatures, parameters, and return values."
---
