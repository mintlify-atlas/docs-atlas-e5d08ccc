---
title: "CrisOS v2 Interactive Shell: Architecture and Command Dispatch"
sidebarTitle: "Shell"
description: "How the CrisOS v2 shell loop reads input, tokenizes commands, dispatches to subsystems, and supports output redirection via echo."
---
