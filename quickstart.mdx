---
title: "Get Started with CrisOS v2"
sidebarTitle: "Quickstart"
description: "Build the CrisOS v2 kernel, generate a bootable ISO with GRUB, and run it in QEMU in under five minutes."
---
...
| `make iso` | Builds the kernel and packs `iso/boot/rootfs.bin` from `rootfs/`. |
