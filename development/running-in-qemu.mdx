---
title: "Running CrisOS v2 in QEMU: Boot, Shell, and Debugging"
sidebarTitle: "QEMU"
description: "Boot the CrisOS v2 i386 kernel in QEMU using make run, observe the full boot sequence output, interact with the shell, and apply debug flags."
---
